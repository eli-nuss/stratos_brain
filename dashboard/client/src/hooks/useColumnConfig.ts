...
export const ALL_COLUMNS: ColumnDef[] = [
  ...
  { id: "primary_setup", label: "Setup", tooltip: "Technical trading pattern identified by our backtesting system. Hover over each setup to learn what it means.", sortField: "primary_setup", minWidth: "120px", align: "center", addedInVersion: 4 },
  { id: "setup_purity_score", label: "Purity", tooltip: "How cleanly the setup criteria are met (0-100). Higher = higher probability. 90+ is textbook, 80+ is strong.", sortField: "setup_purity_score", minWidth: "100px", align: "center", addedInVersion: 4 },
