...
The Daily Brief is an AI-generated market summary that highlights the most promising trading setups for the day. It is generated by a dedicated `daily-brief-api` edge function that uses the Gemini-3-Pro-Preview model to analyze all assets in the database.

**Key Features:**
- **Market Overview**: A summary of the current market conditions.
- **Top Setups**: The best bullish and bearish opportunities with detailed reasoning.
- **Key Signals**: A summary of the most important technical signals.
- **Sector Analysis**: A breakdown of performance and sentiment by sector.
