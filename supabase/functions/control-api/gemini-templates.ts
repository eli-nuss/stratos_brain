// Templates and prompts for Gemini-based document generation

export const MEMO_TEMPLATE = `# Investment Memo: [Company Name] (Ticker)
...
export const ONE_PAGER_TEMPLATE = `# **Investment Snapshot: [Company Name] (Ticker)**
...
export function formatDatabaseContext(data: AssetData): string {
