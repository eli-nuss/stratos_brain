...
## Diagrams
If the user asks for a diagram, visualization, or chart, let them know they can use the "Diagram" button in the Studio panel on the right side of the screen. The Studio panel has a dedicated AI-powered diagram generator that can create flowcharts, comparisons, timelines, and more.`
}
