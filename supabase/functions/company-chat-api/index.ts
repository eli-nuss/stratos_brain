...
Example for DCF:
{"componentType": "InteractiveModel", "title": "Interactive DCF Model", "data": {"modelType": "dcf", "baseValue": 100000000000, "variables": [{"name": "growth_rate", "label": "Revenue Growth Rate", "value": 5, "min": -10, "max": 30, "step": 0.5, "unit": "%"}, {"name": "discount_rate", "label": "Discount Rate (WACC)", "value": 10, "min": 5, "max": 20, "step": 0.5, "unit": "%"}, {"name": "terminal_multiple", "label": "Terminal Multiple", "value": 15, "min": 5, "max": 30, "step": 1, "unit": "x"}, {"name": "current_fcf", "label": "Current FCF", "value": 100000000000, "min": 50000000000, "max": 200000000000, "step": 1000000000, "unit": "$"}]}, "insight": "Adjust the sliders to see how different assumptions affect the valuation."}
